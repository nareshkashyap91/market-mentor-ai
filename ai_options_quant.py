...
def recommend_options_quant_strategies(index_name, spot, vwap, regime, pcr, vix_val, pattern_name, pattern_bias):
    ...
    from margin_engine import get_strategy_margin
    ...
    for s in strategies:
        ...
        # Attach Phase 5 Capital & Margin Requirement
        margin_info = get_strategy_margin(index_name, s["type"], s["legs"], spot)
        s["margin_info"] = margin_info
...
def main():
    ...
    # Phase 9 Model Versioning & Research AI Synthesis
    ...
    if tg_token and tg_chat_id:
        if check_market_hours():
            ...
            print("[INFO] Market is closed. Skipping Telegram broadcast for AI Quant Engine.")
